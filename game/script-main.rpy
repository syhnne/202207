...
label temporary3:
    ...
    a '这都能忘的吗……'
    y '没办法，当时走得比较着急……差点也忘了把校服外套拿过来。'
    a '你不回家取的吗？'
    y '不去，懒得回去。'
    a '呃，所以从你搬到酒店以来，就从来没洗过衣服……？'
    y '我确实只有这一件衣服，但是我会洗。'
    y '很简单，衣服没干的话就别来学校，这样就不用穿校服了。'
    a '哇，这就是高三人的自律生活吗。'
    y '没错，高三可比高二轻松多了。'
    y '虽然高三每天都会留一个晚上写不完的作业，放学时间最晚，周六还要额外补课…'
    y '…但是你可以不学，没人拦得住你。'
    menu:
        '6。':
            pass
        '我怀疑你在凡尔赛……':
            a '我觉得这话从你一个实验班的人嘴里说出来，很没有说服力……'
    ...
    menu:
        '确定不是回家偷偷开卷吗……':
            y '怎么可能，正经人谁写作业啊，你写作业吗？'
            a '不写作业会被当众点名，可能还会被找家长……'
            y '点名就点名呗，别理他就行。'
            a ''
...
label temporary6:
    ## 现在第一段写的比较无趣，得给他改改，一是埋伏笔，二是疯狂玩梗避免观众走人，三是这东西是规则类怪谈啊，别忘了自己要干嘛。。。
    ## 怎么把主角开局去世这事圆回来啊，哼哼啊啊啊啊啊啊啊啊啊啊啊啊
    a '什么校规。正经人谁遵守校规啊！你遵守校规吗？'
    b '我不遵守啊。你遵守校规吗？'
    a '规则不就是用来打破的吗？'
    b '都打破了那还能叫校规吗？'
    'a&b' '下贱！'
